...
#Usage
#python multipartupload.py -f lakeformation.mp4 -b cgg.datalake.raw -cs 10
#python multipartupload.py -f lakeformation.mp4 -b cgg.datalake.raw -k video/lake.mp4 -cs 10
