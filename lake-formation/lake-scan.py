...
def main():
    ...
    ap.add_argument('-a', '--action', choices = ['grant', 'revoke', 'scan'],  required = True,  help = "Filter by resource type")
    ap.add_argument('-r', '--resource', choices = ['table', 'database', 'data_location'], help = "Filter by resource type")
